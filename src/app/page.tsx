  ...
  return (
   <main className="grow">
    ...
    <section className=" bg-orange-50 py-12">
      <div className="flex flex-col gap-6 items-center container mx-auto px-4">
        <h1 className="text-3xl sm:text-5xl font-bold text-center">Receitas deliciosas</h1>
        <p className="text-lg sm:text-xl text-center">Descubra receitas simples e sabororsas para todas as ocasiões</p>
